...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, DeviceScannedDelegate, PairUnPairDeviceDelegate {
    ...
    @objc var connectedPeripheral: CBPeripheral?
    @objc var scanController: BLEDeviceScan?
    @objc var pairController: BLEDeviceConnection?
    var sameDevice: Bool? = false
    @objc var deviceArray: NSArray?
    ...
    @objc func setCurrentConnectedPeripherel(connectedPeripheral: CBPeripheral?) {
        self.connectedPeripheral = connectedPeripheral
    }
    //Get current connected perpheral
    @objc func getCurrentConnectedPeripheral() -> CBPeripheral? {
